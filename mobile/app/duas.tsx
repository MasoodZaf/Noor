                ...
                <View style={styles.categoriesList}>
                    {DUA_CATEGORIES.map((category) => (
                        ...
                        >
                            ...
                            <Feather
                                name={activeCategory === category.id ? "chevron-down" : "chevron-right"}
                                size={20}
                                color="#5E5C58"
                            />
                        </TouchableOpacity>
                ...
                {activeCategory === 'morning' && (
                    <View style={styles.expandedContent}>
                        <View style={styles.duaCard}>
                            <Text style={styles.duaArabic}>أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ</Text>
                            <Text style={styles.duaTranslation}>"We have reached the morning and at this very time unto Allah belongs all sovereignty..."</Text>
                            <View style={styles.duaActions}>
                                <Text style={styles.duaReference}>Hisn al-Muslim 75</Text>
                                <TouchableOpacity>
                        ...
                        <View style={styles.duaCard}>
                            <Text style={styles.duaArabic}>اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا</Text>
                            <Text style={styles.duaTranslation}>"O Allah, by You we enter the morning and by You we enter the evening..."</Text>
                            <View style={styles.duaActions}>
                                <Text style={styles.duaReference}>Hisn al-Muslim 76</Text>
                                <TouchableOpacity>
                                    <Feather name="bookmark" size={20} color="#5E5C58" />
                                </TouchableOpacity>
                            </View>
